 ...
 */
public class WaitOrderFragment extends Fragment implements ConfirmFragmentView,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_wait_order, container, false);
        ...
        switch (item.getItemId()){
            case R.id.action_submit:{
                ...
                if(confirmOrderPreviews.size()>0) {
                    ...
                    presenter.confirmOrder(orderIDSet, customerIDSet, 4);
    ...
    public void onClick(int pos, String msg) {
        ...
        presenter.fetchDeleteOrder(orderPreview.getId(), orderPreview.getCustomerID(), msg,2);
    }
}
